...
#define STRING_CONFIG_H_AUTHOR "(Ethan + Dust, Ender-3 Pro)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Creality Ender-3
    ...
    #define DEFAULT_Kp_LIST {  32.80,  32.80 }
    #define DEFAULT_Ki_LIST {   3.76,   3.76 }
    #define DEFAULT_Kd_LIST {  71.80,  71.80 }
  #else
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 169.40
  #define DEFAULT_bedKi  31.54
  #define DEFAULT_bedKd 606.60
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -43, -10, -1.80 }
